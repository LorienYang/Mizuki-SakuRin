...
export const siteConfig: SiteConfig = {
	title: "Sakura Reverie",
	subtitle: "樱之境",
	siteURL: "https://blog.sakurin.cn/", // 请替换为你的站点URL，以斜杠结尾
	...
	navbarTitle: {
		...
		icon: "Rin/assets/pic/svg/logo.svg",
		// 网站Logo图片路径
		logo: "Rin/assets/pic/svg/logo.svg",
	},
	...
	banner: {
		...
		src: {
			...
			desktop: ["/Rin/assets/pic/webp/aili4k_aafde.webp"],
		}, // 使用本地横幅图片
...
export const profileConfig: ProfileConfig = {
	avatar: "https://q.qlogo.cn/headimg_dl?dst_uin=2730826304&spec=640&img_type=jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Lorien Yang",
	bio: "愛してた，さよなら。",
	typewriter: {
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/473089208",
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/LorienYang",
		},
	],
};
...
export const announcementConfig: AnnouncementConfig = {
	title: "你好啊，我的朋友！", // 公告标题，填空使用i18n字符串Key.announcement
	content: "欢迎你来到我的小站，你可以随便看看。", // 公告内容
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://api.baka.plus/meting/?server=:server&type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址
	id: "3343971835", // 歌单ID
